...
export function Component() {
  ...
  const auth = useAuth();
  const { signIn, resendConfirmationEmail } = auth || {};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : 'Error durante el login';
      setError(errorMsg);
      setIsLoading(false);
    }
  };
            ...
            />
              ...
              <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
                ...
                <div className="text-center space-y-1 mb-5">
                  ...
                  >
                    Inicia sesión para continuar en ESPeak
                  </motion.p>
                </div>
          ...
          {notConfirmed && (
            ...
            >
              ...
              <motion.div
                ...
                className="w-16 h-16 rounded-full bg-yellow-500/20 border-2 border-yellow-500 flex items-center justify-center mb-4"
              >
              ...
              >
                Tu cuenta está creada pero aún necesita confirmarse.
              </motion.p>
              ...
              >
                <p>Revisa tu correo electrónico para encontrar el enlace de confirmación.</p>
                <p className="text-white/60 text-xs">Si no lo encuentras, verifica tu carpeta de spam.</p>
              </motion.div>
